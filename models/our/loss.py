...
class CtdetLoss(torch.nn.Module):
    ...
    def forward(self, data_dict, pr_dict):
        ...
        data_dict['hm']=data_dict['hm'].cuda()
        data_dict['wh']=data_dict['wh'].cuda()
        data_dict['reg_mask']=data_dict['reg_mask'].cuda()
        data_dict['ind']=data_dict['ind'].cuda()
        #data_dict['reg']=data_dict['reg'].cuda()
