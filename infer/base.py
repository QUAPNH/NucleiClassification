...
class InferManager(object):
    ...
    def __load_model(self):
        ...
        """
        model_desc = import_module("models.our.net_desc")
        model_creator = getattr(model_desc, "create_model")
        heads = {'hm': 1,
                'wh': 2}
        heads_dict={'heads':heads}
        self.method["model_args"].update(heads_dict)
